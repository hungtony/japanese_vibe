...
export const chaptersN5 = [
  ...
  // ---- 第 7 關：動詞啟動 (～ます / ～ました) ----
  {
    ...
    grammar: [
      {
        pattern: '動詞的分類 (I類、II類、III類)',
        explanation: '日文動詞依據變化規則分為三類，學會分類是後續所有動詞變化的基礎：\n【III類動詞】不規則動詞，只有兩個：「します (做)」和「来ます/きます (來)」。包含名詞+します(如：勉強します)。\n【II類動詞】字尾特徵：ます前面的音通常是「え段」音（如：食(た)べます、寝(ね)ます）。也有少數是「い段」音（如：見(み)ます、起(お)きます、借(か)ります）。\n【I類動詞】字尾特徵：ます前面的音是「い段」音（如：飲(の)みます、行(い)きます、話(はな)します）。',
        examples: [
          { jp: '勉強{べんきょう}します / 来{き}ます', romaji: 'benkyō shimasu / kimasu', zh: '學習 / 來 (III類)' },
          { jp: '食{た}べます / 見{み}ます', romaji: 'tabemasu / mimasu', zh: '吃 / 看 (II類)' },
          { jp: '飲{の}みます / 行{い}きます', romaji: 'nomimasu / ikimasu', zh: '喝 / 去 (I類)' }
        ]
      },
      {
        pattern: '動詞ます形 (肯定/否定/過去)',
        explanation: '「ます」是動詞的敬體結尾，給人禮貌的感覺。\n【時態變化規則】\n・現在/未來肯定：〜ます (做... / 將要做...)\n・現在/未來否定：〜ません (不做... / 不將做...)\n・過去肯定：〜ました (做了...)\n・過去否定：〜ませんでした (沒有做...)\n\n※動詞雖然分為三類，但其「ます形」的字尾變化規則都是相同的。',
        examples: [
    ...
    grammar: [
      {
        ...
        explanation: '日文形容詞用來修飾名詞，分為兩類：\n・い形容詞：字尾一定有「い」，如「高(たか)い」「安(やす)い」。作為結尾時，直接加「です」。修飾名詞時直接接續。\n・な形容詞：通常不以「い」結尾。作為結尾時用「です」。修飾名詞時，必須在名詞前加上「な」。\n※【重要例外】：有少數字尾是「い」，但卻是「な形容詞」，如「きれい(漂亮)」「有名(ゆうめい/有名)」「嫌い(きらい/討厭)」。這些例外需要特別記憶。',
        examples: [
    ...
    grammar: [
      {
        ...
        explanation: '形容詞的時態變化規則：\n【い形容詞】去掉字尾的「い」，加上對應的語尾：\n・否定：〜くないです (如：高くないです / 不貴)\n・過去：〜かったです (如：高かったです / 以前很貴)\n・過去否定：〜くなかったです (如：高くなかったです / 以前不貴)\n※【重要例外】：「いい」(好) 的變化是用「よい」去變：よくないです(不好)、よかったです(太好了)。\n【な形容詞】與名詞的變化規則完全相同：\n・否定：〜じゃありません (如：静かじゃありません / 不安靜)\n・過去：〜でした (如：静かでした / 以前很安靜)\n・過去否定：〜じゃありませんでした (如：静かじゃありませんでした / 以前不安靜)',
        examples: [
