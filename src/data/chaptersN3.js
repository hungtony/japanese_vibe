...
export const chaptersN3 = [
  ...
  // ---- 第 59 關：原來是這麼一回事 (理解與結論：～わけだ / ～というわけだ) ----
  {
    id: 'n3_ch59',
    level: 'N3',
  ...
  // ---- 第 67 關：有這個壞可能 (擔憂與可能：～恐れがある / ～かもしれない) ----
  {
    id: 'n3_ch67',
    level: 'N3',
    title: '有這個壞可能 (擔憂與可能)',
  ...
  // ---- 第 70 關：話也不能這麼說 (部分否定：～わけではない / ～とは限らない) ----
  {
    id: 'n3_ch70',
    level: 'N3',
    title: '話也不能這麼說 (部分否定)',
  ...
  // ---- 第 72 關：這才是社會常理 (普遍真理：～ものだ / ～ものではない) ----
  {
    id: 'n3_ch72',
    level: 'N3',
    title: '這才是社會常理 (～ものだ)',
  ...
  // ---- 第 75 關：不管再怎麼努力 (逆接條件：～たとえ～ても / ～いくら～ても) ----
  {
    id: 'n3_ch75',
    level: 'N3',
    title: '不管再怎麼努力 (逆接條件)',
  ...
  // ---- 第 76 關：伴隨著變化 (隨著A，B也改變：～にしたがって / ～につれて) ----
  {
    id: 'n3_ch76',
    level: 'N3',
  ...
  // ---- 第 78 關：從...角度來看 (判斷根據：～からいうと / ～から見ると) ----
  {
    id: 'n3_ch78',
    level: 'N3',
    title: '從...角度來看 (判斷根據)',
  ...
  // ---- 第 80 關：竟然...太誇張了 (輕視與驚訝：～なんて / ～なんか / ～とは) ----
  {
    id: 'n3_ch80',
    level: 'N3',
    title: '竟然...太誇張了 (輕視與驚訝)',
